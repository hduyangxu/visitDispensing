...
public interface PresDrugRepository extends JpaRepository<PresDrugEntity, Integer> {
    ...
    int addPresDrug(int pres_id, String drug_name, String dose, String dose_unit, String frequency, String drug_usage, int take_days, int quantity, double price, String remark);
