...
public interface DrugRepository extends JpaRepository<DrugEntity, Integer> {
    ...
    @Query(value = "select * from drug where drug_name like ?1% limit 20", nativeQuery = true)
    ...
    void addDrug(String drug_name, String trade_name, String pinyin_code, String specification, char pack_unit, double price, double dose, String dose_unit, String factory_name, String approval_number);

    @Modifying
    @Query(value = "update drug set drug_name=?,trade_name=?,pinyin_code=?,specification=?,pack_unit=?,price=?,dose=?,dose_unit=?,factory_name=?,approval_number=?", nativeQuery = true)
    void modifyDrug(String drug_name, String trade_name, String pinyin_code, String specification, char pack_unit, double price, double dose, String dose_unit, String factory_name, String approval_number);
